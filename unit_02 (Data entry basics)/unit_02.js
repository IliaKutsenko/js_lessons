...
// Переменная e1 это строка. И получается, что мы просто к строке '3' добавили цифру 5. Получилось 35. 
...
function t9() {
    ...
    data.value = '';
    // Я пробовал сделать так data.value = '';
    // но оно почему-то не сработало.
}
...
function t10() {
    ...
    let a = +data.value;
    document.querySelector('.out-10').textContent = a * 20;
}
...
function t12() {
    ...
    document.querySelector('.out-12').textContent = 'Hello ' + i1 + ' ' + i2;
}
...
function t13() {
    let i1 = document.querySelector('.i-13-1');
    let i2 = document.querySelector('.i-13-2');
    let a = +i1.value;
    let b = +i2.value;
...
function t14() {
    let i = document.querySelector('.i-14');
    i.value = 'Go';
}
