...
function t9() {
    document.querySelector('.div-9').innerHTML = '<img src="img/2.png">';
}
...
function t10() {
    document.querySelector('.div-10').innerHTML = '<img src="img/2.png">';
}
...
function t11() {
    document.querySelector('.div-11').innerHTML = '<img src="img/2.png">';
}

// ваше событие здесь!!!
document.querySelector('.div-11').onmouseenter = t11;
document.querySelector('.div-11').onmouseleave = () => {
    document.querySelector('.div-11').innerHTML = '<img src="img/1.png">';
}
...
// функцию пишите самостоятельно
let a13 = document.querySelector('.div-13');
a13.onmousedown = () => {
...
function t15() {
    n++
    document.querySelector('.out-15').textContent = n;
}
// ваше событие здесь!!!
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = w16 + 'px';
}
// ваше событие здесь!!!
...
function t18() {
    ...
    document.querySelector('.out-18').textContent = width + 'px';
}
// ваше событие здесь!!!
...
function t19() {
    ...
    document.querySelector('.out-19').textContent = classes;
}
// ваше событие здесь!!!
