...
let ar1 = ['Progs', 555, -1, true, false] // переменную обьявляем здесь!!!!
...
let ar2 = ['Kuku', 'Hi', 96, true]; // переменную обьявляем здесь!!!!
...
let ar3 = [321, 'Hi', '999', -5, true]; // переменную обьявляем здесь!!!!
