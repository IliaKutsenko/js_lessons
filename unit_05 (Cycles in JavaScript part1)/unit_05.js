...
function t6() {
    let out = '';
    let i1 = document.querySelector('.i-6').value;
    for (i = 1; i <= i1; i++) {
        out += '******<br>';
    }
...
function t7() {
    let out = '';
    let i1 = document.querySelector('.i-7').value;
    for (i = i1; i >= 0; i--) {
        out += i + '_';
    }
...
function t13() {
    let i1 = document.getElementsByClassName('i-13');
...
function t14() {
    let out = '';
    let i1 = document.getElementsByClassName('i-14');
    for (i = 0; i < i1.length; i++) {
        if (i1[i].checked) {
            out = i1[i].value;
        }
