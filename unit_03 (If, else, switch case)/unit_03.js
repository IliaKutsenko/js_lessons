...
function f13() {
   ...
   // Потому что num не переведена в тип данных number.
   // Если необходимо получить number, то код выше должен выглядеть так - let num = +document.querySelector('.i-130').value;
